...
public abstract class WebPage {
    ...
    protected void waitForPageElement(PageElement pageElement) {
        ...
        case WAITFORELEMENTTOBECLICKABLE:
            if (!isWebElementAvailableInPageElement)
                ...
                webDriverWrapper.waitForElementToBeClickable((By) pageElement.getWebElement(), pageElement.getTimeOut());
            break;
        ...
        case WAITFORELEMENTTOBEEENABLED:
            if (!isWebElementAvailableInPageElement)
                ...
                webDriverWrapper.waitForElementToBeEnabled((By) pageElement.getWebElement(), pageElement.getTimeOut());
            break;
        ...
        case WAITFORELEMENTTOBEDISPLAYED:
            if (!isWebElementAvailableInPageElement)
                ...
                webDriverWrapper.waitForElementToBeDisplayed((By) pageElement.getWebElement(), pageElement.getTimeOut());
            break;
        default:
            break;
        }
    ...
    protected void sendKeys (PageElement pageElement, String value) throws Throwable {
        try {
            ...
            if (!isWebElementAvailableInPageElement(pageElement))
                ...
                ((WebElement) pageElement.getWebElement()).sendKeys(value);
    ...
    protected void sendKeys (PageElement pageElement, Keys key) throws Throwable {
        try {
            if (!isWebElementAvailableInPageElement(pageElement))
                getWebElement(pageElement).sendKeys(key);
            else
                ((WebElement) pageElement.getWebElement()).sendKeys(key);
        } catch (Exception exception) {
    ...
    protected void clearAndSendKeys (PageElement pageElement, String value) throws Throwable {
        try {
            WebElement element;
            if (!isWebElementAvailableInPageElement(pageElement))
                element = getWebElement(pageElement);
            else
                element = (WebElement) pageElement.getWebElement();
    ...
    protected void SelectValueAndTypeForTextField (PageElement pageElement, String value) throws Throwable {
        try {
            WebElement element;
            if (!isWebElementAvailableInPageElement(pageElement))
                element = getWebElement(pageElement);
    ...
    protected void SelectValueAndTypeForHomeTextField (PageElement pageElement, String value) throws Throwable {
        try {
            WebElement element;
            if (!isWebElementAvailableInPageElement(pageElement))
                element = getWebElement(pageElement);
    ...
    protected void click(PageElement pageElement){
        try {
          ...
          System.out.println("Failed to click on : '" + pageElement.getName() + "' on : '" + pageName + "' Refer to Sheet:  '"+CustomizableEntity.runningSheetName+"' "+ "' Column Name:  '"+CustomizableEntity.runningElement+"' "+ "' Row Reference :  '"+CustomizableEntity.runningRowReference+"' ");
        } finally {
            pageElement = null;
        }
    }
...
*/        } finally {
    ...
    protected void selectDateFromCalender(PageElement pageElement,String dateToBeAdded) throws Exception{
        String date=null;
    ...
    protected void switchForSearchCriteria(PageElement pageElement,String searchFieldLocator,String searchCriteria,String frameName) throws Throwable{
        try {
            click(pageElement);
            Thread.sleep(500);
            switchToWindow();
    ...
    protected void clearAndSendKey (PageElement pageElement, String value) throws Throwable {
        try {
            WebElement element;
            if (!isWebElementAvailableInPageElement(pageElement))
                element = getWebElement(pageElement);
    ...
    protected String fetchValueFromFieldsforClaimParty(PageElement pageElement) throws ScriptExecutionException {
        String text = new String();
        try {
            WebElement webElement;
            if (!isWebElementAvailableInPageElement(pageElement))
